  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item v-show="false" label="职务" :labelCol="labelCol" :wrapperCol="wrapperCol">
        ...
        <!--部门分配-->
        <a-form-item v-show="false/* !departDisabled*/" label="部门分配" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-search
              placeholder="点击选择部门"
        ...
        <!--租户分配-->
        <a-form-item v-show="false/* !departDisabled*/" label="租户分配" :labelCol="labelCol" :wrapperCol="wrapperCol">
        ...
        <a-form-item v-show="false" label="身份" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-radio-group
              v-model="identity"
        ...
        <a-form-item v-show="false" label="负责部门" :labelCol="labelCol" :wrapperCol="wrapperCol" v-if="departIdShow==true">
          <a-select
              mode="multiple"
              style="width: 100%"
              placeholder="请选择负责部门"
        ...
        <a-form-item label="头像" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <s-image-upload class="avatar-uploader" text="上传" v-model="fileList"></s-image-upload>
        </a-form-item>
        ...
        <a-form-item v-show="false" label="座机" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入座机" v-decorator="[ 'telephone', validatorRules.telephone]"/>
        </a-form-item>

        <a-form-item v-show="false" label="工作流引擎" :labelCol="labelCol" :wrapperCol="wrapperCol">
...
import JSelectPosition from '@/components/sbcbiz/JSelectPosition'
