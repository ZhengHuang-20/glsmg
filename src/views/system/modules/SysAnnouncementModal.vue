        ...
        <a-row style="width: 100%;">
          <a-col :span="24/2">
            <a-form-model-item
              ...
              prop="startTime"
              label="开始时间:">
              <s-date style="width: 100%" :getCalendarContainer="node => node.parentNode" v-model="model.startTime"  placeholder="请选择开始时间" showTime dateFormat="YYYY-MM-DD HH:mm:ss" ></s-date>
            </a-form-model-item>
          </a-col>
          <a-col :span="24/2">
            <a-form-model-item
              ...
              label="结束时间"
              class="endTime">
              <s-date style="width: 100%" :getCalendarContainer="node => node.parentNode" v-model="model.endTime" placeholder="请选择结束时间" showTime dateFormat="YYYY-MM-DD HH:mm:ss"></s-date>
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row style="width: 100%;">
        ...
        <a-row style="width: 100%;">
          <a-col :span="24">
            <a-form-model-item
              ...
              label="内容"
              class="s-field-content">
              <editor v-model="model.msgContent"></editor>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
...
<script>
  ...
  import SDate from '@/components/sbc/SDate'
  import SelectUserListModal from "./SelectUserListModal";
  import moment from 'moment'
  import Editor from "@/components/editor/Editor";

  export default {
    components: {Editor, SDate, SelectUserListModal},
