...
import { USER_NAME,USER_INFO,USER_AUTH,SYS_BUTTON_AUTH,UI_CACHE_DB_DICT_DATA,TENANT_ID,CACHE_INCLUDED_ROUTES } from "@/store/mutation-types"
      ...
      return new Promise((resolve, reject) => {
        queryPermissionsByUser().then(response => {
          ...
          if (menuData && menuData.length > 0) {
            ...
            commit('account/setRoutesConfig', menuData)
